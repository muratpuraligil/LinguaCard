...
const ArchiveView: React.FC<ArchiveViewProps> = ({ words, onExit, onRestore, onClearArchive }) => {
    ...
    <div className="min-h-screen bg-black text-white p-6 md:p-10 font-['Plus_Jakarta_Sans'] flex flex-col items-center">
        ...
        <div className="flex items-center gap-6 mb-12">
          ...
          {words.length > 0 && (
            <button
              ...
              className="ml-auto flex items-center gap-2 px-4 py-3 bg-red-500/10 text-red-500 rounded-xl hover:bg-red-500 hover:text-white transition-all font-black text-xs uppercase tracking-widest border border-red-500/20"
            >
              <Trash2 size={16} />
              Arşivi Boşalt
            </button>
      ...
      {showClearConfirm && (
        <DeleteModal
          ...
          description={`Arşivdeki ${words.length} kelimenin tamamını silmek istediğine emin misin? Bu işlem geri alınamaz.`}
          onConfirm={() => {
            onClearArchive();
